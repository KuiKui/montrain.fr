...
abstract class BaseMessage extends BaseObject  implements Persistent {
	...
	public function setDiscussionId($v)
	{
		...
		if ($this->discussion_id !== $v) {
			...
			$this->modifiedColumns[] = MessagePeer::DISCUSSION_ID;
		}
	...
	public function setContenu($v)
	{
		...
		if ($this->contenu !== $v) {
			$this->contenu = $v;
			$this->modifiedColumns[] = MessagePeer::CONTENU;
		}
	...
	public function setValide($v)
	{
		...
		if ($this->valide !== $v || $this->isNew()) {
			$this->valide = $v;
			$this->modifiedColumns[] = MessagePeer::VALIDE;
		}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aDiscussion !== null) {
				if (!$this->aDiscussion->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aDiscussion->getValidationFailures());
				}
			}
	...
	/**
	 * Declares an association between this object and a Discussion object.
	 *
	 * @param      Discussion $v
	 * @return     Message The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setDiscussion(Discussion $v = null)
	{
		if ($v === null) {
		...
		// If this object has already been added to the Discussion object, it will not be re-added.
		if ($v !== null) {
			$v->addMessage($this);
		}
	...
	/**
	 * Get the associated Discussion object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     Discussion The associated Discussion object.
	 * @throws     PropelException
	 */
	public function getDiscussion(PropelPDO $con = null)
	{
		if ($this->aDiscussion === null && ($this->discussion_id !== null)) {
			$this->aDiscussion = DiscussionPeer::retrieveByPk($this->discussion_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aDiscussion->addMessages($this);
			 */
		}
